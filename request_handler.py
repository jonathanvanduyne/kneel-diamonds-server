"""This module is responsible for handling all requests to the server."""
import json
...
class HandleRequests(BaseHTTPRequestHandler):
    ...
    def parse_url(self, path):
        """Parses a URL path and returns a resource with its identifier"""
    ...
    def do_POST(self):
        ...
        if resource == "orders":
            # Pass the decoded JSON dictionary as an argument
            if "metalId" in post_body and "sizesId" in post_body and "styleId" in post_body:
                self._set_headers(201)
